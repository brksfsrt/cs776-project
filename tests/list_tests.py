...
class TestListFunctions(unittest.TestCase):
    def setUp(self):
        self.array_size = 100
        self.test_list = List(sorted(create_array(self.array_size - 1) + [100000]), "randomWord")
    ...
    def test_f_search(self):
        ...
        returned_index = self.test_list.f_search(key, 4)
        self.assertEqual(returned_index, unreachable_index+4)

        key = 100000
        returned_index = self.test_list.f_search(key, 10)
        self.assertEqual(returned_index, 99)
